...
// get all course ---wtihout purchasing 
...
export const addReview = CatchAsyncError(async(req:Request,res:Response,next:NextFunction)=>{
    try{
        ...
        // check if courseId already exists is userCourseList based on _id 
        ...
        if(course){
            course.ratings = avg/ course.reviews.length; //one example we have 2 reviews one is 5 anothe is 4 so math working like this 9/2 = 4.5 rating
        }
...
export const getAllCoursesControl = CatchAsyncError(async(req:Request, res:Response,next:NextFunction)=>{
    try{
